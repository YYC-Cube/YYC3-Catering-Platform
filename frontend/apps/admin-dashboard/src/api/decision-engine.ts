...
class DecisionEngineAPI {
  ...
  async submitAnalysis(
    requestId: string,
    analysis: Partial<DecisionAnalysis>,
  ): Promise<{
    success: boolean;
  ...
  async getDecisionAnalyses(requestId: string): Promise<{
    ...
    try {
      const response: AxiosResponse = await httpClient.get(`/decision-engine/requests/${requestId}/analyses`);
      return response.data;
    } catch (error) {
   ...
   * 创建协同决策
   */
  async createCollaborativeDecision(
    requestId: string,
    decision: Partial<CollaborativeDecision>,
  ): Promise<{
    success: boolean;
  ...
  async getCollaborativeDecision(decisionId: string): Promise<{
    ...
    try {
      const response: AxiosResponse = await httpClient.get(`/decision-engine/decisions/${decisionId}`);
      return response.data;
    } catch (error) {
  ...
  async updateDecisionStatus(
    ...
    try {
      const response: AxiosResponse = await httpClient.put(`/decision-engine/decisions/${decisionId}/status`, {
        status,
        comment,
      });
      return response.data;
  ...
  async startExecution(decisionId: string): Promise<{
    ...
    try {
      const response: AxiosResponse = await httpClient.post(`/decision-engine/decisions/${decisionId}/execution`);
      return response.data;
    } catch (error) {
  ...
  async getExecutionStatus(decisionId: string): Promise<{
    ...
    try {
      const response: AxiosResponse = await httpClient.get(`/decision-engine/decisions/${decisionId}/execution`);
      return response.data;
    } catch (error) {
  ...
  async getAIAnalysis(requestId: string): Promise<{
    ...
    try {
      const response: AxiosResponse = await httpClient.get(`/decision-engine/requests/${requestId}/ai-analysis`);
      return response.data;
    } catch (error) {
   ...
   * 获取决策模板
   */
  async getDecisionTemplates(params?: { type?: DecisionType; level?: DecisionLevel; category?: string }): Promise<{
    success: boolean;
    data?: Array<{
      id: string;
      name: string;
