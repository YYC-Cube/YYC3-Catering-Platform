...
export class ChainStoreController {
  ...
  async createStore(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const store = await this.chainStoreService.createStore(tenantId, createStoreDto, createdBy);
  ...
  async updateStore(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const store = await this.chainStoreService.updateStore(tenantId, id, updateStoreDto, updatedBy);
  ...
  async getStorePerformanceRanking(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const ranking = await this.chainStoreService.getStorePerformanceRanking(tenantId, period as string);
  ...
  async syncStoreConfig(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const result = await this.chainStoreService.syncStoreConfig(tenantId, id, configType);
