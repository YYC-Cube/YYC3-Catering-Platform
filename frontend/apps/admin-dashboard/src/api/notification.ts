...
export class NotificationAPI {
  ...
  ): Promise<{ success: boolean; data: { items: Notification[]; pagination: any }; message?: string }> {
    try {
      ...
      const response = await httpClient.get<{
        success: boolean;
        data: { items: Notification[]; pagination: any };
        message?: string;
      }>(endpoint);
      return response;
    } catch (error) {
  ...
  async getNotification(id: number): Promise<{ success: boolean; data?: Notification; message?: string }> {
    try {
      const response = await httpClient.get<{ success: boolean; data?: Notification; message?: string }>(
        `/notifications/${id}`,
      );
      return response;
    } catch (error) {
  ...
  async createNotification(
    ...
    try {
      const response = await httpClient.post<{ success: boolean; data?: Notification; message?: string }>(
        '/notifications',
        data,
      );
      return response;
  ...
  async getNotificationStats(): Promise<{ success: boolean; data?: NotificationStats; message?: string }> {
    try {
      const response = await httpClient.get<{ success: boolean; data?: NotificationStats; message?: string }>(
        '/notifications/stats',
      );
      return response;
    } catch (error) {
  ...
  async getNotificationSettings(): Promise<{ success: boolean; data?: NotificationSettings; message?: string }> {
    try {
      const response = await httpClient.get<{ success: boolean; data?: NotificationSettings; message?: string }>(
  ...
  async updateNotificationSettings(
    ...
    try {
      const response = await httpClient.put<{ success: boolean; data?: NotificationSettings; message?: string }>(
        '/notifications/settings',
        settings,
      );
      return response;
  ...
  async getNotificationTemplates(): Promise<{ success: boolean; data?: NotificationTemplate[]; message?: string }> {
    try {
      const response = await httpClient.get<{ success: boolean; data?: NotificationTemplate[]; message?: string }>(
