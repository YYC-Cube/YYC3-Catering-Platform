 ...
 * @param message 错误消息
 */
export const notFoundResponse = (res: Response, message: string = ErrorMessage[ErrorCode.NOT_FOUND]): Response => {
 ...
 * @param message 错误消息
 */
export const forbiddenResponse = (res: Response, message: string = ErrorMessage[ErrorCode.FORBIDDEN]): Response => {
