  ...
  <div class="ai-chat-interface">
    ...
    <div class="ai-chat-content" ref="chatContentRef">
      ...
      <div v-else class="ai-messages-list">
        <AIMessageBubble v-for="(message, index) in messages" :key="index" :message="message" :index="index" />
      </div>
    </div>
    ...
    <div class="ai-chat-input-container">
      <div class="ai-chat-input-wrapper">
        ...
        <div class="ai-input-actions">
          <button class="ai-attach-btn" title="附加文件">
            <svg
              width="18"
              height="18"
              viewBox="0 0 24 24"
...
// 欢迎建议
const suggestions = ['推荐一些热门菜品', '如何创建一个新的菜单', '查看今日订单统计', '帮助设置菜品分类'];
...
watch(inputMessage, () => {
  ...
  if (inputMessage.value.trim().length > 2) {
    inputSuggestions.value = suggestions.filter(s => s.toLowerCase().includes(inputMessage.value.toLowerCase()));
  } else {
