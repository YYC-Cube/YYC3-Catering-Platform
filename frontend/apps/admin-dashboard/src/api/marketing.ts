...
export class MarketingAPI {
  ...
  async getMarketingActivity(id: number): Promise<{ success: boolean; data?: MarketingActivity; message?: string }> {
    try {
      const response = await httpClient.get<{ success: boolean; data?: MarketingActivity; message?: string }>(
   ...
   * 创建营销活动
   */
  async createMarketingActivity(
    activityData: CreateMarketingActivityRequest,
  ): Promise<{ success: boolean; data?: MarketingActivity; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: MarketingActivity; message?: string }>(
  ...
  async updateMarketingActivity(
    id: number,
    activityData: UpdateMarketingActivityRequest,
  ): Promise<{ success: boolean; data?: MarketingActivity; message?: string }> {
    try {
      const response = await httpClient.put<{ success: boolean; data?: MarketingActivity; message?: string }>(
        `/marketing/activities/${id}`,
        activityData,
      );
      return response;
  ...
  async publishMarketingActivity(id: number): Promise<{ success: boolean; message?: string }> {
    try {
      const response = await httpClient.patch<{ success: boolean; message?: string }>(
        `/marketing/activities/${id}/publish`,
      );
      return response;
    } catch (error) {
   ...
   * 复制营销活动
   */
  async duplicateMarketingActivity(
    id: number,
    newName: string,
  ): Promise<{ success: boolean; data?: MarketingActivity; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: MarketingActivity; message?: string }>(
        `/marketing/activities/${id}/duplicate`,
        { newName },
      );
      return response;
    } catch (error) {
...
export const createMarketingActivity = (activityData: CreateMarketingActivityRequest) =>
  marketingApi.createMarketingActivity(activityData);
export const updateMarketingActivity = (id: number, activityData: UpdateMarketingActivityRequest) =>
  marketingApi.updateMarketingActivity(id, activityData);
...
export const getMarketingStats = (params?: { startDate?: string; endDate?: string }) =>
  marketingApi.getMarketingStats(params);
export const sendMarketingNotification = (activityId: number, channels: string[]) =>
  marketingApi.sendMarketingNotification(activityId, channels);
export const duplicateMarketingActivity = (id: number, newName: string) =>
  marketingApi.duplicateMarketingActivity(id, newName);
