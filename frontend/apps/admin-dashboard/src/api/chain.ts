...
export class ChainAPI {
  ...
  ): Promise<{ success: boolean; data: { items: Store[]; pagination: any }; message?: string }> {
    try {
      ...
      const response = await request.get<{
        success: boolean;
        data: { items: Store[]; pagination: any };
        message?: string;
      }>(endpoint);
      return response;
    } catch (error) {
  ...
  async getStore(id: number): Promise<{ success: boolean; data?: Store; message?: string }> {
    try {
      const response = await request.get<{ success: boolean; data?: Store; message?: string }>(
  ...
  async createStore(storeData: CreateStoreRequest): Promise<{ success: boolean; data?: Store; message?: string }> {
    try {
      const response = await request.post<{ success: boolean; data?: Store; message?: string }>(
        `${this.baseUrl}/stores`,
        storeData,
      );
      return response;
  ...
  async updateStore(
    ...
    try {
      const response = await request.put<{ success: boolean; data?: Store; message?: string }>(
        `${this.baseUrl}/stores/${id}`,
        storeData,
      );
      return response;
  ...
  async updateStoreStatus(id: number, status: StoreStatus): Promise<{ success: boolean; message?: string }> {
    try {
      const response = await request.patch<{ success: boolean; message?: string }>(
        `${this.baseUrl}/stores/${id}/status`,
        { status },
      );
      return response;
    } catch (error) {
  ...
  async getStoreStats(
    ...
    startDate?: string,
    endDate?: string,
  ): Promise<{ success: boolean; data?: StoreStats; message?: string }> {
    try {
      const queryString = new URLSearchParams();
      ...
      const endpoint = queryString.toString()
        ? `${this.baseUrl}/stores/${id}/stats?${queryString}`
        : `${this.baseUrl}/stores/${id}/stats`;
  ...
  ): Promise<{ success: boolean; data: { items: Employee[]; pagination: any }; message?: string }> {
    try {
      const queryString = new URLSearchParams();
      if (params?.page) queryString.set('page', params.page.toString());
      if (params?.limit) queryString.set('limit', params.limit.toString());
      ...
      const response = await request.get<{
        success: boolean;
        data: { items: Employee[]; pagination: any };
        message?: string;
      }>(endpoint);
      return response;
    } catch (error) {
  ...
  async getEmployee(id: number): Promise<{ success: boolean; data?: Employee; message?: string }> {
    try {
      const response = await request.get<{ success: boolean; data?: Employee; message?: string }>(
  ...
  async createEmployee(
    ...
    try {
      const response = await request.post<{ success: boolean; data?: Employee; message?: string }>(
        `${this.baseUrl}/employees`,
        employeeData,
      );
      return response;
  ...
  async updateEmployee(
    ...
    try {
      const response = await request.put<{ success: boolean; data?: Employee; message?: string }>(
        `${this.baseUrl}/employees/${id}`,
        employeeData,
      );
      return response;
  ...
  async updateEmployeePermissions(id: number, permissions: string[]): Promise<{ success: boolean; message?: string }> {
    try {
      const response = await request.put<{ success: boolean; message?: string }>(
        `${this.baseUrl}/employees/${id}/permissions`,
        { permissions },
      );
      return response;
    } catch (error) {
  ...
  async getEmployeePerformance(
    ...
    startDate?: string,
    endDate?: string,
  ): Promise<{ success: boolean; data?: EmployeePerformance; message?: string }> {
    try {
      const queryString = new URLSearchParams();
      if (startDate) queryString.set('startDate', startDate);
      if (endDate) queryString.set('endDate', endDate);
      ...
      const endpoint = queryString.toString()
        ? `${this.baseUrl}/employees/${id}/performance?${queryString}`
        : `${this.baseUrl}/employees/${id}/performance`;
  ...
  ): Promise<{ success: boolean; data: { items: Inventory[]; pagination: any }; message?: string }> {
    try {
      const queryString = new URLSearchParams();
      if (params?.page) queryString.set('page', params.page.toString());
      if (params?.limit) queryString.set('limit', params.limit.toString());
      ...
      const response = await request.get<{
        success: boolean;
        data: { items: Inventory[]; pagination: any };
        message?: string;
      }>(endpoint);
      return response;
    } catch (error) {
  ...
  async getInventoryItem(id: number): Promise<{ success: boolean; data?: Inventory; message?: string }> {
    try {
      const response = await request.get<{ success: boolean; data?: Inventory; message?: string }>(
  ...
  async restockInventory(restockData: RestockInventoryRequest): Promise<{ success: boolean; message?: string }> {
    try {
      const response = await request.post<{ success: boolean; message?: string }>(
        `${this.baseUrl}/inventory/restock`,
        restockData,
      );
      return response;
    } catch (error) {
  ...
  async transferInventory(transferData: TransferInventoryRequest): Promise<{ success: boolean; message?: string }> {
    try {
      const response = await request.post<{ success: boolean; message?: string }>(
        `${this.baseUrl}/inventory/transfer`,
        transferData,
      );
      return response;
    } catch (error) {
  ...
  async getInventoryWarnings(storeId?: number): Promise<{ success: boolean; data: Inventory[]; message?: string }> {
    try {
      ...
      const endpoint = queryString.toString()
        ? `${this.baseUrl}/inventory/warnings?${queryString}`
        : `${this.baseUrl}/inventory/warnings`;
  ...
  async getStoreStatsOverview(
    ...
    try {
      ...
      const endpoint = queryString.toString()
        ? `${this.baseUrl}/stats/stores?${queryString}`
        : `${this.baseUrl}/stats/stores`;
      const response = await request.get<{ success: boolean; data: StoreStats[]; message?: string }>(endpoint);
      return response;
    } catch (error) {
  ...
  async getEmployeePerformanceOverview(
    storeId?: number,
    startDate?: string,
    endDate?: string,
  ): Promise<{ success: boolean; data: EmployeePerformance[]; message?: string }> {
    try {
      ...
      const endpoint = queryString.toString()
        ? `${this.baseUrl}/stats/employees?${queryString}`
        : `${this.baseUrl}/stats/employees`;
      const response = await request.get<{ success: boolean; data: EmployeePerformance[]; message?: string }>(endpoint);
      return response;
    } catch (error) {
  ...
  ): Promise<{ success: boolean; data: RevenueComparison[]; message?: string }> {
    try {
      const queryString = new URLSearchParams();
      ...
      const endpoint = queryString.toString()
        ? `${this.baseUrl}/stats/revenue?${queryString}`
  ...
  async getTrendAnalysis(
    storeId: number,
    dimension: 'orders' | 'revenue' | 'customers' | 'employees',
    startDate?: string,
    endDate?: string,
    ...
    try {
      ...
      const endpoint = queryString.toString()
        ? `${this.baseUrl}/stats/trends?${queryString}`
        : `${this.baseUrl}/stats/trends`;
