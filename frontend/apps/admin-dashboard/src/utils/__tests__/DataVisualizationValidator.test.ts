...
describe('DataVisualizationValidator', () => {
  ...
  describe('数据一致性验证', () => {
    it('应该验证图表数据与原始数据一致', () => {
      ...
      const result = DataVisualizationValidator.validateChartDataConsistency(chartInstance, rawData);
    ...
    it('应该处理空图表实例', () => {
      const result = DataVisualizationValidator.validateChartDataConsistency(null as any, [1, 2, 3]);
