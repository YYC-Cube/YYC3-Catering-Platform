...
const commonStubs = {
  ...
  'el-card': {
    template:
      '<div class="el-card"><div class="el-card__header"><slot name="header"></slot></div><div class="el-card__body"><slot></slot></div></div>',
  },
  'el-statistic': {
    template:
      '<div><slot name="title"></slot><span class="el-statistic__content">{{ value }}</span><slot name="suffix"></slot></div>',
    props: ['value'],
  },
