...
path: config.keyStore?.path || path.join(**dirname, '../../keys'),
...
backupStrategy: {
enabled: true,
path: config.keyStore?.backupPath || path.join(**dirname, '../../backups'),
intervalDays: 7,
encrypted: true,
},
highAvailability: {
...
path: gatewayConfig.keyStore?.path || path.join(**dirname, '../../keys'),
...
backupStrategy: {
enabled: true,
path: gatewayConfig.keyStore?.backupPath || path.join(**dirname, '../../backups'),
intervalDays: 7,
encrypted: true,
},
highAvailability: {
...
keyExpiration: 90 _24_ 60 _60_ 1000, // 90天
autoRotate: true,
rotationInterval: 30 _24_ 60 _60_ 1000, // 30天
