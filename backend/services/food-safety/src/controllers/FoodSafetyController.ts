...
export class FoodSafetyController {
  ...
  async createTraceRecord(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const traceRecord = await this.foodSafetyService.createTraceRecord(tenantId, createTraceDto, createdBy);
  ...
  async traceProductChain(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const traceChain = await this.foodSafetyService.traceProductChain(tenantId, productId, batchNumber);
  ...
  async performSafetyCheck(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const checkResult = await this.foodSafetyService.performSafetyCheck(tenantId, safetyCheckDto, inspectedBy);
  ...
  async recallProduct(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const recallResult = await this.foodSafetyService.recallProduct(tenantId, recallDto, initiatedBy);
  ...
  async generateTraceQRCode(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const qrCodeData = await this.foodSafetyService.generateTraceQRCode(tenantId, productId, batchNumber);
