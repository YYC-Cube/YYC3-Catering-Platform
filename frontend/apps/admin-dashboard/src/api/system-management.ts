...
export const systemManagementApi = {
  ...
  getRoles: async (params?: { page?: number; pageSize?: number; keyword?: string; status?: string }) => {
  ...
  getPermissions: async (params?: { module?: string; type?: string; status?: string }) => {
  ...
  getDepartments: async (params?: { keyword?: string; status?: string }) => {
  ...
  getSettings: async (params?: { category?: string; isPublic?: boolean }) => {
  ...
  updateSetting: async (data: { key: string; value: string }) => {
    return request<SystemSetting>({
