...
export const foodSafetyApi = {
  ...
  getSafetySummary: async (params?: { startDate?: string; endDate?: string }) => {
  ...
  exportIngredients: async (params?: { status?: string; category?: string; startDate?: string; endDate?: string }) => {
    return request<Blob>({
  ...
  exportInspections: async (params?: { startDate?: string; endDate?: string; inspector?: string }) => {
    return request<Blob>({
  ...
  generateInspectionReport: async (params?: { startDate?: string; endDate?: string; inspectionType?: string }) => {
    return request<Blob>({
