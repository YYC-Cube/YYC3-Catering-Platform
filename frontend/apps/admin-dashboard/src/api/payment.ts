...
export class PaymentAPI {
  ...
  async getPaymentConfigs(): Promise<{ success: boolean; data?: PaymentConfig[]; message?: string }> {
    try {
      const response = await httpClient.get<{ success: boolean; data?: PaymentConfig[]; message?: string }>(
        '/payment/configs',
      );
      return response;
    } catch (error) {
  ...
  async createPaymentConfig(
    configData: CreatePaymentConfigRequest,
  ): Promise<{ success: boolean; data?: PaymentConfig; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: PaymentConfig; message?: string }>(
        '/payment/configs',
        configData,
      );
      return response;
  ...
  async updatePaymentConfig(
    id: number,
    configData: UpdatePaymentConfigRequest,
  ): Promise<{ success: boolean; data?: PaymentConfig; message?: string }> {
    try {
      const response = await httpClient.put<{ success: boolean; data?: PaymentConfig; message?: string }>(
        `/payment/configs/${id}`,
        configData,
      );
      return response;
  ...
  async togglePaymentConfig(id: number, enabled: boolean): Promise<{ success: boolean; message?: string }> {
    try {
      const response = await httpClient.patch<{ success: boolean; message?: string }>(`/payment/configs/${id}/toggle`, {
        enabled,
      });
      return response;
    } catch (error) {
  ...
  ): Promise<{ success: boolean; data: { items: PaymentTransaction[]; pagination: any }; message?: string }> {
    try {
      ...
      const response = await httpClient.get<{
        success: boolean;
        data: { items: PaymentTransaction[]; pagination: any };
        message?: string;
      }>(endpoint);
      return response;
    } catch (error) {
  ...
  async getPaymentTransaction(id: number): Promise<{ success: boolean; data?: PaymentTransaction; message?: string }> {
    try {
      const response = await httpClient.get<{ success: boolean; data?: PaymentTransaction; message?: string }>(
  ...
  async getRefundRecords(
    params?: PaymentQueryParams,
  ): Promise<{ success: boolean; data: { items: RefundRecord[]; pagination: any }; message?: string }> {
    try {
      const queryString = new URLSearchParams();
      if (params?.page) queryString.set('page', params.page.toString());
      if (params?.limit) queryString.set('limit', params.limit.toString());
      ...
      const response = await httpClient.get<{
        success: boolean;
        data: { items: RefundRecord[]; pagination: any };
        message?: string;
      }>(endpoint);
      return response;
    } catch (error) {
  ...
  ): Promise<{ success: boolean; data?: RefundRecord; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: RefundRecord; message?: string }>(
        '/payment/refunds',
        refundData,
      );
      return response;
  ...
  async testPaymentConfig(
    id: number,
    testData?: { amount?: number },
  ): Promise<{ success: boolean; data?: any; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: any; message?: string }>(
        `/payment/configs/${id}/test`,
        testData || { amount: 1 },
      );
      return response;
    } catch (error) {
  ...
  async exportTransactions(
    ...
    try {
      ...
      const endpoint = queryString.toString()
        ? `/payment/transactions/export?${queryString}`
        : '/payment/transactions/export';
      const response = await httpClient.get<{ success: boolean; data?: { downloadUrl: string }; message?: string }>(
        endpoint,
      );
      return response;
    } catch (error) {
...
export const createPaymentConfig = (configData: CreatePaymentConfigRequest) =>
  paymentApi.createPaymentConfig(configData);
export const updatePaymentConfig = (id: number, configData: UpdatePaymentConfigRequest) =>
  paymentApi.updatePaymentConfig(id, configData);
...
export const testPaymentConfig = (id: number, testData?: { amount?: number }) =>
  paymentApi.testPaymentConfig(id, testData);
