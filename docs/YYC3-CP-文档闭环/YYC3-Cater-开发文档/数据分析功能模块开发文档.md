...
export function getSalesAnalytics(params: { dateRange: DateRange }): Promise<SalesAnalytics>;
```
...
export function getCustomerAnalytics(params: { dateRange: DateRange }): Promise<CustomerAnalytics>;
```
...
export function getMenuAnalytics(params: { dateRange: DateRange }): Promise<MenuAnalytics>;
```
...
export function getOperationalAnalytics(params: { dateRange: DateRange }): Promise<OperationalAnalytics>;
```
...
export function getPredictiveAnalytics(params: { dateRange: DateRange }): Promise<PredictiveAnalytics>;
```
...
export function getDashboardData(params: { dateRange: DateRange }): Promise<DashboardData>;
```
...
```typescript
export function getAlertHistory(params: { page: number; pageSize: number }): Promise<{ list: Alert[]; total: number }>;
```
