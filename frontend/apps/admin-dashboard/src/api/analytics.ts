...
export class AnalyticsAPI {
  ...
  ): Promise<{ success: boolean; data?: SalesAnalytics; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: SalesAnalytics; message?: string }>(
        '/analytics/sales',
        params,
      );
      return response;
  ...
  async getCustomerAnalytics(
    params: AnalyticsRequest,
  ): Promise<{ success: boolean; data?: CustomerAnalytics; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: CustomerAnalytics; message?: string }>(
        '/analytics/customer',
        params,
      );
      return response;
  ...
  async getMenuAnalytics(
    params: AnalyticsRequest,
  ): Promise<{ success: boolean; data?: MenuAnalytics; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: MenuAnalytics; message?: string }>(
        '/analytics/menu',
        params,
      );
      return response;
  ...
  async getOperationalAnalytics(
    params: AnalyticsRequest,
  ): Promise<{ success: boolean; data?: OperationalAnalytics; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: OperationalAnalytics; message?: string }>(
  ...
  async getMarketingAnalytics(
    params: AnalyticsRequest,
  ): Promise<{ success: boolean; data?: MarketingAnalytics; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: MarketingAnalytics; message?: string }>(
        '/analytics/marketing',
        params,
      );
      return response;
  ...
  async getPredictiveAnalytics(
    params: AnalyticsRequest,
  ): Promise<{ success: boolean; data?: PredictiveAnalytics; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: PredictiveAnalytics; message?: string }>(
  ...
  async getDashboardData(params: {
    ...
    try {
      const response = await httpClient.post<{ success: boolean; data?: Record<string, any>; message?: string }>(
        '/analytics/dashboard',
        params,
      );
      return response;
  ...
  ): Promise<{ success: boolean; data?: { reportId: string; downloadUrl: string }; message?: string }> {
    try {
  ...
  async getDashboardConfigs(): Promise<{ success: boolean; data?: DashboardConfig[]; message?: string }> {
    try {
      const response = await httpClient.get<{ success: boolean; data?: DashboardConfig[]; message?: string }>(
  ...
  ): Promise<{ success: boolean; data?: DashboardConfig; message?: string }> {
    try {
      const response = await httpClient.post<{ success: boolean; data?: DashboardConfig; message?: string }>(
        '/analytics/dashboards',
        config,
      );
      return response;
  ...
  async updateDashboard(
    ...
    try {
      const response = await httpClient.put<{ success: boolean; data?: DashboardConfig; message?: string }>(
  ...
  async exportData(params: {
    ...
    try {
      const response = await httpClient.post<{ success: boolean; data?: { downloadUrl: string }; message?: string }>(
        '/analytics/export',
        params,
      );
      return response;
...
export const createDashboard = (config: Omit<DashboardConfig, 'id' | 'createdAt' | 'updatedAt'>) =>
  analyticsApi.createDashboard(config);
export const updateDashboard = (id: number, config: Partial<DashboardConfig>) =>
  analyticsApi.updateDashboard(id, config);
...
export const getRealTimeData = (params?: { metrics?: string[]; refreshInterval?: number }) =>
